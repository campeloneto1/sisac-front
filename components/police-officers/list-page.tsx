    ...
    return (
      <Card className="border-slate-200/70 bg-white/80">
        <CardHeader>
          ...
          <CardDescription>Você precisa da permissão `viewAny` para visualizar policiais.</CardDescription>
        </CardHeader>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Gestão completa do cadastro de policiais militares, seus dados pessoais e vínculos funcionais.</p>
        </div>
