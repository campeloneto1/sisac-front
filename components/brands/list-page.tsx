    ...
    return (
      <Card className="border-slate-200/70 bg-white/80">
        <CardHeader>
          ...
          <CardDescription>Voce precisa de `administrator` e `brands.viewAny` para visualizar marcas.</CardDescription>
        </CardHeader>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Cadastre e organize marcas usadas por variantes e catalogos mestres.</p>
        </div>
      ...
      {brandsQuery.isLoading ? (
        ...
        <Card className="border-slate-200/70 bg-white/80">
          <CardHeader>
            ...
            <CardDescription>Crie uma nova marca ou refine os filtros aplicados.</CardDescription>
          </CardHeader>
        </Card>
      ) : (
