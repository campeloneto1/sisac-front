...
import { ArrowLeft, Boxes, Package, ShieldAlert } from "lucide-react";
...
interface MaterialUnitsPageShellProps {
  title: string;
  description: string;
...
export function MaterialUnitsPageShell({
  title,
  description,
  requiredPermission,
  showIntegrationNotice = false,
  children,
}: MaterialUnitsPageShellProps) {
