    ...
    return (
      <Card className="border-slate-200/70 bg-white/80">
        <CardHeader>
          ...
          <CardDescription>Voce nao possui permissao suficiente para acessar a gestao de lotes deste material.</CardDescription>
        </CardHeader>
      </Card>
    );
  }
        ...
        <Card className="border-amber-200/80 bg-amber-50/80">
          <CardHeader>
            ...
            <CardDescription className="text-amber-800">
              O backend ja devolve lotes dentro do `Material.show`, mas ainda nao expoe endpoints dedicados para CRUD de `MaterialBatch`.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2 text-sm text-amber-900">
            <p>Esta area ja consegue listar e detalhar lotes usando o payload do material.</p>
