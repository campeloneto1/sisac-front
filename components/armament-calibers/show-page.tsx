    ...
    return (
      <Card className="border-slate-200/70 bg-white/80">
        <CardHeader>
          ...
          <CardDescription>
            Você precisa da permissão `view` para visualizar calibres de
            armamento.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <Card className="border-slate-200/70 bg-white/80">
          <CardHeader>
            ...
            <CardDescription>
              Informações principais usadas no cadastro do calibre.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200/70 bg-slate-50 p-4">
              ...
              <p className="whitespace-pre-wrap text-sm text-slate-700">
                {armamentCaliber.description || "Nenhuma descrição informada."}
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="rounded-2xl border border-slate-200/70 bg-slate-50 p-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                {armamentCaliber.creator?.name || "Usuário não informado"}
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200/70 bg-slate-50 p-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                {armamentCaliber.updater?.name || "Usuário não informado"}
              </p>
            </div>
          </CardContent>
        </Card>
